...
<?php
	...
	printf ('<table>
		...
		echo '<td><input type="text" name="title" value="'.$post->getTitle().'" readonly="readonly"></td>';
		echo '<td><input type="text" name="author" value="'.$post->getAuthor().'" readonly="readonly"></td>';
