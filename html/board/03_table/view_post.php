...
<?php
	...
	if($row = mysqli_fetch_assoc($result)) {
		...
		echo '<td><input type="text" name="title" value="'.$row['title'].'" readonly></td>';
	...
	echo '</table>';
	echo '<div style="float:right;margin-top:10px;"><a href="index.php"><input type="button" value="목록보기"></a></div>';
